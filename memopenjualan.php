	...
	if(isset($_POST['no_penjualan']))
		{
			...
			{
			$db->execute("INSERT INTO penjualan(no_penjualan,tgl_penjualan,id_customer,nama_customer,tgl_kirim,tipe,jumlah,hargabeli,hargakardus,marginpersen,hargajual,hargajualtotal,pajak, hrgjualdgnpajak, hargabelitotal,margintotal,tgl_dibayar,tgl_jatuh_tempo,keterangan,no_po,no_invoice,sistem_bayar,metode_bayar,tgl_invoice,username,tgl_transaksi,statusdibayar) values ('$no_penjualan','$tgl_penjualan','$id_customer','$nama_customer','$tgl_kirim','$tipe','$jumlah','$hargabeli','$hargakardus','$margin','$hargajual','$hargajualtotal','$denganpajak','$hargadenganpajak','$total','$margintotal',NOW(),'$tgl_jatuh_tempo_penjualan','$keterangan','$no_po',$no_invoice,'$sistem_bayar','$metode_bayar','$tgl_invoice_penjualan','$username',NOW(), 'LUNAS')");
			...
			$db->execute("INSERT INTO penjualan(no_penjualan,tgl_penjualan,id_customer,nama_customer,tgl_kirim,tipe,jumlah,hargabeli,hargakardus,marginpersen,hargajual,hargajualtotal,pajak, hrgjualdgnpajak, hargabelitotal,margintotal,tgl_dibayar,tgl_jatuh_tempo,keterangan,no_po,no_invoice,sistem_bayar,metode_bayar,tgl_invoice,username,tgl_transaksi) values ('$no_penjualan','$tgl_penjualan','$id_customer','$nama_customer','$tgl_kirim','$tipe','$jumlah','$hargabeli','$hargakardus','$margin','$hargajual','$hargajualtotal','$denganpajak','$hargadenganpajak','$total','$margintotal',NOW(),'$tgl_jatuh_tempo_penjualan','$keterangan','$no_po',$no_invoice,'$sistem_bayar','$metode_bayar','$tgl_invoice_penjualan','$username',NOW())");
...
<form name="penjualan" method="post" action="">
	...
	<p align="center">
			<table>
			        ...
			        <td><input style="height: 30px;margin-bottom: 0px" name="no_penjualan" type="text" id="no_penjualan" value="<?php echo $line->no_penjualan; ?>"></td>
			        ...
			        <td><input style="height: 30px;margin-bottom: 0px" id="jumlah" class="jumlah" name="jumlah" type="text" value="<?php echo $line->jumlah; ?> " onkeyup="setHargaBeli()" oninput="setHarga(this.id, this.value)" onchange="setHarga(this.id, this.value)"></td>
			        ...
			        <td><input style="height: 30px;margin-bottom: 0px" type="text" id="hargabeli" name="hargabeli" value="<?php echo $line2->hargabeli; ?>" ></td>
			        <td><div align="left" style="margin-left: 20px"><strong>Harga Beli Total</strong></div></td>
			        <td><input style="height: 30px;margin-bottom: 0px" type="text" id="hargabelitotal" name="hargabelitotal" value="<?php echo $line2->hargabelitotal; ?>" oninput="setHarga(this.id, this.value)" onchange="setHarga(this.id, this.value)"></td>
			        </tr>
			        <tr>
			        ...
			        <td><input style="height: 30px;margin-bottom: 0px" type="text" id="hargakardus" name="hargakardus" value="<?php echo $line->hargakardus; ?>" oninput="setHarga(this.id, this.value)" onchange="setHarga(this.id, this.value)"></td>
			        <td><div align="left" style="margin-left: 20px"><strong>Total</strong></div></td>
			        <td><input readonly style="height: 30px;margin-bottom: 0px" type="text" id="total" name="total" value="<?php echo $line->hargabelitotal; ?>" oninput="setHarga(this.id, this.value)" onchange="setHarga(this.id, this.value)"></td>
			        </tr>
			        <tr>
			        <td><div align="left"><strong>Harga Jual</strong></div></td>
			        <td><input style="height: 30px;margin-bottom: 0px" type="text" id="hargajual" name="hargajual" value="<?php echo $line->hargajual; ?>" oninput="setHarga(this.id, this.value)" onchange="setHarga(this.id, this.value)"></td>
			        <td><div align="left" style="margin-left: 20px"><strong>Harga Jual tanpa Pajak</strong></div></td>
			        <td><input readonly style="height: 30px;margin-bottom: 0px" type="text" id="hargajualtotal" name="hargajualtotal" value="<?php echo $line->hargajualtotal; ?>" oninput="setHarga(this.id, this.value)" onchange="setHarga(this.id, this.value)"></td>
			        </tr>
			        <tr>
			        <td><div align="left"><strong>Margin(%)</strong></div></td>
			        <td><input style="height: 30px;margin-bottom: 0px" type="text" id="margin" name="margin" value="<?php echo $line->marginpersen; ?>" oninput="setHarga(this.id, this.value)" onchange="setHarga(this.id, this.value)"></td>
			        <td><div align="left" style="margin-left: 20px"><strong>Total Margin</strong></div></td>
			        <td><input readonly style="height: 30px;margin-bottom: 0px" type="text" id="margintotal" name="margintotal" value="<?php echo $line->margintotal; ?>" oninput="setHarga(this.id, this.value)" onchange="setHarga(this.id, this.value)"></td>
			        </tr>
					<tr>
					<td><div align="left"><strong>Pajak (%)</strong></div></td>
					<td><input style="height: 30px;margin-bottom: 0px" name="denganpajak" id="denganpajak" type="text" onchange="setHarga(this.id, this.value)" oninput="setHarga(this.id, this.value)" value="<?php echo $line->pajak; ?>" oninput="setHarga(this.id, this.value)" onchange="setHarga(this.id, this.value)"></td>
					<td><div align="left" style="margin-left: 20px"><strong>Harga Jual dengan Pajak</strong></div></td>
					<td><input readonly style="height: 30px;margin-bottom: 0px" name="hargadenganpajak" id="hargadenganpajak" type="text" value="<?php echo $line->hrgjualdgnpajak; ?>" oninput="setHarga(this.id, this.value)" onchange="setHarga(this.id, this.value)"></td>
					</tr>
			        <tr>
			        <td><div align="left"><strong>No. Invoice Penjualan</strong></div></td>
			        <td><input style="height: 30px;margin-bottom: 0px" type="text" id="no_invoice_penjualan" name="no_invoice_penjualan" value="<?php echo $line->no_invoice; ?>"></td>					
			        <td><div align="left" style="margin-left: 20px"><strong>Tanggal Invoice Penjualan</strong></div></td>
			        <td><input style="height: 30px;margin-bottom: 0px" type="text" id="tgl_invoice_penjualan" name="tgl_invoice_penjualan" value="<?php echo date('d-m-Y', strtotime($line->tgl_invoice)); ?>"></td>
			        </tr>							
					<tr>
					<td><strong>Sistem Bayar</strong></td><td><select style="height: 30px;margin-bottom: 0px" id="sistem_bayar" name="sistem_bayar" onchange="showhidefields(this.value)" required><option value="">Tidak ada</option><option value="CASH" <?php if ($line->sistem_bayar=='CASH') { echo "selected"; } ?>>Cash</option><option value="TEMPO" <?php if ($line->sistem_bayar=='TEMPO') { echo "selected"; } ?>>Tempo</option></td>
					<td><div align="left" style="margin-left: 20px"><strong>Pembayaran</strong></td><td><select style="height: 30px;margin-bottom: 0px;" name="metode_bayar"><option value="">Tidak ada</option><option value=1 <?php if ($line->metode_bayar==1) { echo "selected"; } ?>>Kas</option><option value=2 <?php if ($line->metode_bayar==2) { echo "selected"; } ?>>Bank</option></select></div></td>
					<td id="tgl_jatuh_tempo_label" style="display:none"><div align="left" style="margin-left: 20px"><strong>Jatuh Tempo</strong></div></td>
			        <td id="tgl_jatuh_tempo_isi" style="display:none"><input style="height: 30px;margin-bottom: 0px" id="tgl_jatuh_tempo_penjualan" class="tgl_jatuh_tempo_penjualan" name="tgl_jatuh_tempo_penjualan" type="text" value="<?php echo date('d-m-Y', strtotime($line->tgl_jatuh_tempo)); ?>"></td>					
					</tr>						
			        </table>
			        <br/>
			        <table>
