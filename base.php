		...
		<div class="wrapper">
			...
			<div class="top-navbar">
				<div class="top-navbar-inner">
					...
					<div class="logo-brand">
						<a href="admin.php"><img src="images/ufood.jpg" alt="Undip Maju"></a>
					</div><!-- /.logo-brand -->
					<!-- End Logo brand -->
			...
			<div class="sidebar-left sidebar-nicescroller">
				<ul class="sidebar-menu">
					<li><a href="admin.php"><i class="fa fa-dashboard icon-sidebar"></i>Dashboard</a></li>
					<li>
						<a href="#">
						...
						<ul class="submenu">
							<li><a href="formhutang.php">Pembayaran Hutang</a></li>
							<li><a href="formpiutang.php">Penerimaan Piutang</a></li>
                            <li><a href="masteringbayarhutangpernopo.php">Hutang Per No.PO</a></li>
                            <li><a href="masteringterimapiutangpernopenjualan.php">Piutang Per No.Penjualan</a></li>
							<li><a href="masteringhutang.php">Daftar Hutang</a></li>
							<li><a href="masteringpiutang.php">Daftar Piutang</a></li>              
						</ul>
					</li>
					<li>
						<a href="#">
						...
						<ul class="submenu">
							<li><a href="masteringpesanan.php">Pesanan</a></li>
						</ul>
					</li>
					<li>
						<a href="#">
					...
					<li>
						...
						<ul class="submenu">
							...
							<li><a href="masterhargabeli.php">Harga Beli</a></li>
							<li><a href="masterhargajual.php">Harga Jual</a></li>
					...
					<li>
						...
						<ul class="submenu">
							<li><a href="lappenjualan.php">Pesanan</a></li>						
							<li><a href="lappembelian.php">Pembelian</a></li>
							<li><a href="lapkas.php">Kas/Bank</a></li>
							<li><a href="lappiutangmutasi.php">Laporan Piutang</a></li>
...
<?php endblock() ?>
				...
				<footer>
					&copy;<script language="JavaScript" type="text/javascript">
						...
						<a href="admin.php">Undip Maju</a><br />
				</footer>
				<!-- END FOOTER -->
