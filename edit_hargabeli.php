...
<form class="form-horizontal" id="form-edithargabeli" method="post">
	...
	<option value="Snack" <?php if ($line2->tipe_produk=='Snack') {echo "selected";}?>>Snack</option>
	<option value="Makanan" <?php if ($line2->tipe_produk=='Makanan') {echo "selected";}?>>Makanan</option>
	<option value="Prasmanan" <?php if ($line2->tipe_produk=='Prasmanan') {echo "selected";}?>>Prasmanan</option>
	</td>
	</tr>
	<tr>
	<td>&nbsp;</td>
