...
<tbody>
    ...
    <tr>
        ...
        <td>
            <a href="edit_supplier.php?id=<?php echo $data['id_supplier'] ?>" id="<?php echo $data['id_supplier'] ?>" class="ubah" data-toggle="modal">
