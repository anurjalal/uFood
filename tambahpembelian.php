	...
	?>
		<p align="center">
			<table>
			        ...
			        <td><input style="height: 30px;margin-bottom: 0px" type="text" id="no_po" name="no_po" value="<?php $maxterima = $db->queryUniqueValue("select MAX(CAST(no_po AS SIGNED)) as no_po from pembelian"); if ($maxterima == NULL) {$maxterima = 1; echo $maxterima;} else {$maxterimabaru = $maxterima + 1; echo $maxterimabaru;} ?>"></td>
					<td><div align="left" style="margin-left: 20px"><strong>Tanggal Pembelian</strong></div></td>
			        <td><input style="height: 30px;margin-bottom: 0px" id="tgl_po" class="tgl_po" name="tgl_po" type="text" value="<?php echo date("d-m-Y"); ?>"></td>					
					<td><div align="left" style="margin-left: 20px"><strong>Tanggal Jatuh Tempo</strong></div></td>
			        <td><input style="height: 30px;margin-bottom: 0px" id="tgl_jatuh_tempo" class="tgl_jatuh_tempo" name="tgl_jatuh_tempo" type="text" value="<?php echo date('d-m-Y',strtotime('+30 days')); ?>"></td>				
					</tr>			
			        <tr>
			        <td><div align="left"><strong>Nama Supplier</strong></div></td>
			        <td><input style="height: 30px;margin-bottom: 0px" type="text" id="nama_supplier" name="nama_supplier" value="" onfocus="setSupplier(this)" onchange="setHargaMakanan()"></td>					
			        ...
			        <td><input style="height: 30px;margin-bottom: 0px" type="text" id="hargabelitotal" name="hargabelitotal" value=""></td>
			        </tr>
			        <tr>
			        <td><div align="left"><strong>No. Invoice Pembelian</strong></div></td>
			        ...
			        <td><input style="height: 30px;margin-bottom: 0px" type="text" id="tgl_invoice" name="tgl_invoice" value="<?php echo date("d-m-Y"); ?>"></td>
			        </tr>					
			        </table>
			        <br/>
			        <table>
