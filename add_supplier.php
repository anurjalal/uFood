...
<?php
	...
	$jml_sup=$data['id_supplier'];
		if($jml_sup == 0) {
            $insert = mysql_query("INSERT INTO supplier(id_supplier,nama_supplier,almt_supplier,telp_supplier,fax_supplier,kota_supplier,cp_supplier,status) VALUES('$id_supplier','$nama_supplier','$almt_supplier','$telp_supplier','$fax_supplier','$kota_supplier','$cp_supplier','$status')");
			if($insert){
