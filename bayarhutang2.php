...
<tbody class="header">
    ...
    <tr>
            ...
            <td><?php echo $data['statusdibayar'] ?></td>
		<td>
		...
		<?php } elseif ($data['statusdibayar']=='LUNAS') { ?>
            ...
            <a href="batalkanpembayaran.php?id=<?php echo $data['no_po']?>" id="<?php echo $data['no_po']?>"> 
                <i><small>Batalkan</small></i>
        </a>
   ...
   <?php } ?> 
    ...
    <input type="submit" name= "Bayar" value="Bayar" style="height:50px;width:100px;">
    </form>
