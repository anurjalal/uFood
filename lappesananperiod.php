...
echo "<table border=1 style='border-collapse:collapse' width=100%>";
	  echo "<tr style='background-color:#00ffff;-webkit-print-color-adjust:exact'><th width=12.5%><font face=\"courier\" size=2> NO </font></th><th width=12.5%><font face=\"courier\" size=2> NAMA PEMESAN </font></th><th width=12.5%><font face=\"courier\" size=2> NO PESANAN </font></th><th width=12.5%><font face=\"courier\" size=2> TANGGAL PESANAN </font></th><th width=12.5%><font face=\"courier\" size=2> JENIS PESANAN </font></th><th width=12.5%><font face=\"courier\" size=2> JUMLAH </font></th><th width=12.5%><font face=\"courier\" size=2> TANGGAL KIRIM </font></th></tr>";
...
$myquery1="SELECT * FROM penjualan where penjualan.tgl_penjualan between '$tanggalawal' and '$tanggalakhir' order by penjualan.nama_customer";
