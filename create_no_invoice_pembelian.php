...
<?php
        ...
        $no_po = $_GET['no_po'];
        $queryinvoice = mysql_query("select max(no_invoice) as no_invoice_max from pembelian");
        $row = mysql_fetch_array($queryinvoice);
        $max_invoice = $row['no_invoice_max'];
        $no_invoice_now =$max_invoice+1;
				...
				<table >
						...
						<table>
							 <tr>
								...
								<div align="right"><td><input style="height: 30px;margin-bottom: 0px" id="no_invoice"  name="no_invoice" type="text" value="<?php echo  $no_invoice_now ?> "> </td></div>
                             </tr>
						</table>
                        <br>
						<table>
